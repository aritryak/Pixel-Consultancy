...
class VideoTile extends StatelessWidget {
  ...
  Widget get rightSideOptions => Column(
        ...
        children: [
          ...
          rightSideOptionsTile(
              icon: Icons.favorite, value: "1.2K", selected: true),
          // Number of likes
  ...
  Widget rightSideOptionsTile(
          {IconData? icon, String? value, bool selected = false}) =>
      Padding(
            ...
            ClayContainer(
              ...
              child: Padding(
                padding: EdgeInsets.only(
                    left: selected ? 2.0 : 0.0, top: selected ? 2.0 : 0.0),
                child: Icon(
                  icon,
                  size: 22.0,
                  color: selected
  ...
  Widget get userName => Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              video.customer?.name ?? "Quiche Fresco",
              style: nameStyle,
            ),
            Padding(
              padding: const EdgeInsets.only(top: 2.0),
              child: Text(
                video.customer?.userName ?? "@quicheFres",
                style: userNameStyle,
              ),
            ),
          ],
  ...
  Widget get userImage => ClayContainer(
        ...
        spread: 2.0,
        child: CircleAvatar(
          backgroundImage: NetworkImage(video.customer?.image ??
